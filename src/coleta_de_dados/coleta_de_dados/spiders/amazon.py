...
class AmazonSpider(scrapy.Spider):
    ...
    def parse(self, response):
        products = response.css('.a-section.a-spacing-small.puis-padding-left-small.puis-padding-right-small')
        for product in products:
           yield {
               'product_name' : product.css('.a-size-base-plus.a-spacing-none.a-color-base.a-text-normal span::text').get(),
               'reviews' : product.css('.a-section.a-spacing-none.a-spacing-top-micro .a-row.a-size-small .a-icon-alt::text').get(),
